/*
	To see other verbs go to https://pkg.go.dev/fmt#hdr-Printing

	Some types include %v - value; %T - type; %d - int into string; %f - float into string; %.xf - x decimal places of float into string
*/
